...
describe('assertAwsSchemaParameters', async () => {
...
describe('schemaTemplateParametersBuiltAfterSelectionPartnerSchema', async () => {
    let sandbox: sinon.SinonSandbox
    beforeEach(() => {
        sandbox = sinon.createSandbox()
    })
...
describe('schemaTemplateParametersBuiltAfterSelectionCustomerUploadedSchema', async () => {
    let sandbox: sinon.SinonSandbox
    beforeEach(() => {
        sandbox = sinon.createSandbox()
    })
...
describe('schemaTemplateParametersBuiltAfterSelectionCustomerUploadedSchemaMultipleTypes', async () => {
    let sandbox: sinon.SinonSandbox
    beforeEach(() => {
        sandbox = sinon.createSandbox()
    })
